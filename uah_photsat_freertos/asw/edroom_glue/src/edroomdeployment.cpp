...
TEDROOMSignal CEDROOMSystemCommSAP::C5ObsMng_PObservCtrl__C4TCManager_PObservCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C4TCManager_PObservCtrl__C5ObsMng_PObservCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCTCManager::SObservTC):	 signalIn=CCObsMng::SObservTC; break;
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp4->ObservCtrl, mp_comp4);
	...
	m_localCommSAP.RegisterInterface(3, mp_comp5->ObservCtrl, mp_comp5);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp5->ObservCtrl, mp_comp4->ObservCtrl, connections[0], 
					C5ObsMng_PObservCtrl__C4TCManager_PObservCtrl, 
					C4TCManager_PObservCtrl__C5ObsMng_PObservCtrl);
