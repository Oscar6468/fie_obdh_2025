...
//Signal Conversion
	...
	static TEDROOMSignal C5ObsMng_PObservCtrl__C4TCManager_PObservCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C4TCManager_PObservCtrl__C5ObsMng_PObservCtrl(TEDROOMSignal signal);
